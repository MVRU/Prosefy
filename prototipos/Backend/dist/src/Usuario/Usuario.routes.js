...
import { findAll, sanitizeInput, add, remove, update, iniciarSesion, getByUsername, findOneByEmail, cerrarSesion, getById, getNombre, getApellido, getEmail, getUsername, getTipo, checkToken, setNombre, setApellido, setEmail, setUsername, setTipo, getUsernameById, getNombreById, getApellidoById, getEmailById, getAvatarById, getTipoById, getUsuarios, eliminarCuenta, getDireccion, setDireccion, setProvincia, getPedidosByUsuarioId } from './Usuario.controller.js';
...
usuarioRouter.get('/get-pedidos/:userId', getPedidosByUsuarioId);
